...
const AA_NOISE_FILTER_MAX_PIXELS = 50000;
/**
...
function imageDiff(a, b, opts) {
    var _a, _b, _c, _d;
    (0, assert_1.default)(opts.colorThreshold !== undefined, 'colorThreshold is missing');
    (0, assert_1.default)(opts.imageThreshold !== undefined, 'imageThreshold is missing');
    ...
    (_d = opts.noiseLineHeightThreshold) !== null && _d !== void 0 ? _d : (opts.noiseLineHeightThreshold = 2);
