...
},{"./src/commands":2,"./src/messages":3}],2:[function(require,module,exports){
'use strict';
...
},{"_process":7,"os":11}],6:[function(require,module,exports){
...
},{"process/browser.js":13,"timers":12}],13:[function(require,module,exports){
...
function jsonOutputFormatter(cmds, rawIndent) {
    ...
    return '[' + EOL + cmds.map(function (cmd) {
        if (cmd.type === COMMANDS.COMPOSITE) {
            return indent + '{"type":"' + COMMANDS.COMPOSITE + '","commands":[' + EOL + cmd.commands.map(function (subcmd) {
...
},{"../../../../modules/browser-puppeteer":1,"../../../../modules/jsonf":4,"../../../../modules/loggr":5,"../../../../modules/ws4ever":6,"../command-list":15,"jquery":8,"lodash.defaults":9,"mithril":10}],15:[function(require,module,exports){
'use strict';
...
},{"../../../modules/browser-puppeteer":1}]},{},[14]);
